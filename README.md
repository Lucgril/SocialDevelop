...
* Open the project with Netbeans. Please refer "SocialDevelop.sql" file inside the folder database to create Tables in MySQL Database, which are required by all the applications. You must first create a database called SocialDevelop.
