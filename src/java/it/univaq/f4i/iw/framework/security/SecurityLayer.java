...
public class SecurityLayer {
    ...
    public static HttpSession checkSession(HttpServletRequest r) {
     ...
     public static HttpSession createSession(HttpServletRequest request, String nome, String cognome, int userid, String amministratore) {
        ...
        s.setAttribute("amministratore", amministratore);
        return s;
    }
