...
public class TemplateResultBackOffice {

    protected ServletContext context;
    protected Configuration cfg;
    protected DataModelFiller filler;

    public TemplateResultBackOffice(ServletContext context) {
    ...
    private void init() {
        ...
        if (context.getInitParameter("view.backoffice_directory") != null) {
            cfg.setServletContextForTemplateLoading(context, context.getInitParameter("view.backoffice_directory"));
        } else {
            cfg.setServletContextForTemplateLoading(context, "backoffice");
        }
    ...
    protected Map getDefaultDataModel() {
        ...
        default_data_model.put("outline_tpl", context.getInitParameter("view.backoffice_template")); //eventuale template di outline
