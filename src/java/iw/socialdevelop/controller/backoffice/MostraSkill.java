...
public class MostraSkill extends SocialDevelopBaseController {
    ...
    private void action_default(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException, TemplateManagerException {
        try {
            ...
            request.setAttribute("page_title", "Skill");
            List<Skill> skills = ((SocialDevelopDataLayer) request.getAttribute("datalayer")).getSkill();
            request.setAttribute("skills", skills);
            res.activate("mostraSkill.html", request, response);
