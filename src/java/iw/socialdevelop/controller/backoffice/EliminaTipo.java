...
public class EliminaTipo extends SocialDevelopBaseController {
    ...
    private void action_default(HttpServletRequest request, HttpServletResponse response, int n) throws DataLayerException, IOException {
        ((SocialDevelopDataLayer) request.getAttribute("datalayer")).deleteTipoSkillByTipo(n);
        ((SocialDevelopDataLayer) request.getAttribute("datalayer")).deleteTipo(n);
