...
function ObjCheckRequired() {
	...
	this.message = "Questo valore non deve essere nullo";
...
function ObjCheckNumber() {
	...
	this.message = "Questo valore non deve essere un numero";
}
...
function ObjRegexpChecker(rx,insensitive) {
	...
	this.message = "Il valore deve essere un'espressione /"+rx+"/";
